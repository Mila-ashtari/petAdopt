...
class UserSlection extends React.Component{
    ...
    // updating type state with user's selection
    handleClick=(event)=>{
        event.persist()
        this.setState({
    ...
    handleLocationClick=(event)=>{
        event.persist()
        // updating locationCoordinates state to be past to app component, 
        // location state to be displayed as input value and locationList 
        // to an empty array so no options are displayed after user selection.
        this.setState({
